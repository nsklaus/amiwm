...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    META = 259,                    /* META  */
    MODIFIER = 260,                /* MODIFIER  */
    WHEREABOUTS = 261,             /* WHEREABOUTS  */
    COLON = 262,                   /* COLON  */
    BAR = 263,                     /* BAR  */
    KEYSYM = 264,                  /* KEYSYM  */
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_MODIFIER = 5,                   /* MODIFIER  */
  YYSYMBOL_WHEREABOUTS = 6,                /* WHEREABOUTS  */
  YYSYMBOL_COLON = 7,                      /* COLON  */
  YYSYMBOL_BAR = 8,                        /* BAR  */
  YYSYMBOL_KEYSYM = 9,                     /* KEYSYM  */
  YYSYMBOL_FUNCTION = 10,                  /* FUNCTION  */
  YYSYMBOL_YYACCEPT = 11,                  /* $accept  */
  YYSYMBOL_bindings = 12,                  /* bindings  */
  YYSYMBOL_binding = 13,                   /* binding  */
  YYSYMBOL_modifiers = 14,                 /* modifiers  */
  YYSYMBOL_whereabouts = 15,               /* whereabouts  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "ERRORTOKEN", "META",
  "MODIFIER", "WHEREABOUTS", "COLON", "BAR", "KEYSYM", "FUNCTION",
  "$accept", "bindings", "binding", "modifiers", "whereabouts", "command", YY_NULLPTR
};
